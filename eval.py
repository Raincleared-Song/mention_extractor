...
def find_max_f1(idx_file_list: list, valid_path: str):
    max_idx, max_f1, max_pre, max_rec = -1, 0.0, 0.0, 0.0
...
def main():
    ...
    step_files.sort()
    max_epoch, max_epoch_f1, max_epoch_pre, max_epoch_rec = find_max_f1(epoch_files, valid_path)
    print('max_epoch:', max_epoch)
    print('max_epoch_f1:', max_epoch_f1)
    print('max_epoch_pre:', max_epoch_pre)
    print('max_epoch_rec:', max_epoch_rec)
    max_step, max_step_f1, max_step_pre, max_step_rec = find_max_f1(step_files, valid_path)
